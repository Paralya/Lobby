...
data modify storage lobby:main Item set value '[{"text":"une ","color":"white"},{"text":"Darkium Pickaxe","color":"gold"},{"text":" !"}]'
execute if score #success lobby.data matches 1 run loot spawn ~ ~ ~ loot stardust:i/darkium_pickaxe
