...
data modify storage lobby:main Item set value '[{"text":"une ","color":"white"},{"text":"Solarium Pickaxe","color":"gold"},{"text":" !"}]'
execute if score #success lobby.data matches 1 run loot spawn ~ ~ ~ loot stardust:i/solarium_pickaxe
