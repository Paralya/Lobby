...
setblock -50 68 31 oak_wall_sign[facing=west]{Text1:'{"text":"Cooked Potato","clickEvent":{"action":"run_command","value":"execute at @s run function lobby:signs/shop/baked_potato"},"color":"gold"}',Text2:'{"text":"(Food)"}',Text3:'{"text":"---------------"}',Text4:'["",{"text":"5000 €"}]'}
