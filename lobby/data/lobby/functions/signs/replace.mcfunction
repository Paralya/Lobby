...
setblock 14 45 0 oak_wall_sign[facing=west]{Text1:'{"text":"1 demi-coeur","clickEvent":{"action":"run_command","value":"execute at @s run function lobby:signs/xp/life_crystal"},"color":"red"}',Text2:'{"text":"permanent","color":"red"}',Text3:'{"text":"---------------"}',Text4:'["",{"text":"45 Levels"}]'}
...
setblock 0 55 -14 oak_wall_sign[facing=north]{Text1:'{"text":"Giant Slime","clickEvent":{"action":"run_command","value":"execute at @s run function lobby:signs/xp/giant_slime"},"color":"green"}',Text2:'{"text":"(Boss)","color":"green"}',Text3:'{"text":"---------------"}',Text4:'["",{"text":"50 Levels"}]'}
