...
#Others
	...
	execute positioned 0 80 0 run spreadplayers 0 0 10 20 false @e[type=!player,type=!armor_stand,type=!marker,type=!wither,type=!slime,type=!ghast,type=!arrow,type=!item,distance=..12]
